...
Adjust the creation time and last access time into local timezone seconds
before encoding, for compatibility.
...
seconds. These values are adjusted to GMT values for for injection.
